...
- (id)init
{
    ...
    if (self)
    {
        ...
        UITapGestureRecognizer *tapGestureRecognizer1 = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(keyboardHide:)];
        ...
        [self.shadowView addGestureRecognizer:tapGestureRecognizer1];
...
-(void)viewWillLayoutSubviews
{
    ...
    if (self.view.superview != nil)
    {
        ...
        r = CGRectMake((sz.width-kWindowWidth)/2, (sz.height-kWindowHeight)/2, kWindowWidth, kWindowHeight * 1.3);//改了这里
    }
    else
    {
        // View is not visible, position outside screen bounds
        r = CGRectMake((sz.width-kWindowWidth)/2, -kWindowHeight, kWindowWidth, kWindowHeight * 1.2);
    }
