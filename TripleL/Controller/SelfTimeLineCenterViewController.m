//
//  SelfTimeLineCenterViewController.m
//  TripleL
//
...
@interface SelfTimeLineCenterViewController () <UIWebViewDelegate, WebControlDelegate>
...
@implementation SelfTimeLineCenterViewController
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    NSURLRequest *request = [[MyServer getServer] getSelfTimelineRequest];
